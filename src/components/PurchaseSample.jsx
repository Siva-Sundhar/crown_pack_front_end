...
const Purchase = () => {
  ...
  const [bottomView, setBottomView] = useState('tax');
  ...
  return (
    <div className="h-dvh w-full overflow-hidden bg-slate-200 p-1 box-border">
      <div className="flex h-full min-h-0 w-full flex-col overflow-hidden rounded-xs border border-black bg-white shadow-md">
        ...
        {/* ============ GST & SUMMARY ============ */}
        {isLast && (
          <section className="grid max-h-[45dvh] shrink-0 grid-cols-1 overflow-y-auto border-t border-slate-400 bg-[#f8f8f8] text-[12px] md:h-65 md:max-h-none md:grid-cols-[7fr_3fr] md:overflow-visible ">
            {/* LEFT - GST Slabs */}
            <div className="grid min-h-0 min-w-0 md:grid-rows-[minmax(0,3fr)_minmax(0,2fr)] md:border-r md:border-slate-300">
              ...
              <div className="min-h-0 overflow-auto p-1 leading-3.5">
              ...
              <div className="min-h-0 border-b border-slate-300 p-1 bg-amber-50">
                <div className="h-full overflow-auto border border-slate-300 max-md:max-h-24">
                    ...
                    <tbody>
                      {totals.slabs.length === 0 ? (
                        ...
                        totals.slabs.map((slab) => (
                          ...
                          >
                            <td className="px-1 font-semibold">{slab.rate}%</td>
