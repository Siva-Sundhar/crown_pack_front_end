...
const GenericSelect = forwardRef(function GenericSelect(
	...
	const isOptionalMatched = (option, query) => {
	...
	const filteredOptions = options.filter((option) => {
		...
		return isOptionalMatched(option, searchTerm);
	});
				...
				<input
					...
					onChange={(e) => {
						...
						const matched = options.filter((option) =>
							isOptionalMatched(option, query),
						);
				...
				>
					...
					>
						...
						>
							...
							{menuHeader && (
								<div style={{ ...defaultMenuHeaderStyle }}>{menuHeader}</div>
							)}
